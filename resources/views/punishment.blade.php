        ...
        <div class="col">
            ...
            <div class="card text-left">
                <div class="card-header">
                    <h3 class="card-title float-none">لائحة الجزاء</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="{{route('punishment.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- text input -->
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="">نوع التهمة</label>
                                    <select name="type" id="" class="form-control form-select">
                                        <option selected disabled>إختار نوع التهمة</option>
                            ...
                            <div class="col-6">
                                <label for="">الحكم</label>
                                <textarea name="judge" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
