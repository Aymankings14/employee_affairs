        ...
        <div class="col">
            ...
            <div class="card text-left">
                <div class="card-header">
                    <h3 class="card-title float-none">طلب إستئذان</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="from_hour" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>الى الساعة</label>
                                    <input type="time" class="form-control" name="to_hour" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
