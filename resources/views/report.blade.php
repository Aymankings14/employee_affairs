        ...
        <div class="col">
            ...
            <div class="card text-left">
                <div class="card-header">
                    <h3 class="card-title float-none">التقارير</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="to_date" id="date" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label>نوع التقرير</label>
                                    <select id="select" class="form-control select2" style="width: 100%;" name="type">
                                        <option selected="selected" disabled>إختر أحد الأنواع</option>
                                        @foreach($types as $type=> $value)
                                            <option value="{{$type}}" {{(old('type')==$type)? 'selected':''}}>{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
